...
class CertifierInfoScreen extends StatelessWidget {
  const CertifierInfoScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          // Top Bar
          const PublicTopBar(showBackButton: true, title: 'Certificatore'),
  ...
  Widget _buildHeroSection(
    ...
    return Column(
      children: [
        ...
        // Title
        Text(
          l10n.getString('certifier_title'),
        ...
        // Subtitle
        Text(
          l10n.getString('certifier_subtitle'),
  ...
  Widget _buildServicesSection(
    ...
    return Column(
      children: [
        Text(
          l10n.getString('certifier_services_title'),
  ...
  Widget _buildBenefitsSection(
    ...
    return Column(
      children: [
        Text(
          l10n.getString('certifier_benefits_title'),
          style: Theme.of(context).textTheme.headlineMedium?.copyWith(
            color: Colors.white,
            fontWeight: FontWeight.w700,
            fontSize: isDesktop ? 32 : 28,
  ...
  Widget _buildHowItWorksSection(
    ...
    return Column(
      children: [
        Text(
          l10n.getString('certifier_how_it_works_title'),
          style: Theme.of(context).textTheme.headlineMedium?.copyWith(
            color: Colors.white,
            fontWeight: FontWeight.w700,
            fontSize: isDesktop ? 32 : 28,
  ...
  Widget _buildCTASection(
    ...
    return Container(
      ...
      child: Column(
        children: [
          Text(
            l10n.getString('certifier_cta_title'),
            style: Theme.of(context).textTheme.headlineMedium?.copyWith(
              color: Colors.white,
              fontWeight: FontWeight.w700,
              fontSize: isDesktop ? 32 : 28,
          ...
          Text(
            l10n.getString('certifier_cta_description'),
            style: Theme.of(context).textTheme.bodyLarge?.copyWith(
              color: Colors.white.withOpacity(0.9),
              fontSize: isDesktop ? 18 : (isTablet ? 16 : 15),
              height: 1.5,
          ...
          Row(
            ...
            children: [
              ElevatedButton(
                ...
                child: Text(
                  l10n.getString('become_certifier'),
                  style: TextStyle(
                    fontSize: isDesktop ? 16 : (isTablet ? 15 : 14),
