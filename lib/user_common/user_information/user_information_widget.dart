...
class _UserInformationWidgetState extends State<UserInformationWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      await Future.wait([
        Future(() async {
          _model.country = await action_blocks.getCountries(context);
        }),
        Future(() async {
          ...
          await Future.wait([
            Future(() async {
              if (_model.user?.firstName != null &&
                  _model.user?.firstName != '') {
                safeSetState(() {
                  _model.firstNameTextController?.text = _model.user!.firstName;
                });
              } else {
                if (_model.user?.fullName != null &&
                    _model.user?.fullName != '') {
                  safeSetState(() {
                    _model.firstNameTextController?.text = functions
                        .getFirstNameFromFullName(_model.user?.fullName);
                  });
                }
              }
            }),
            Future(() async {
              if (_model.user?.lastName != null &&
                  _model.user?.lastName != '') {
                safeSetState(() {
                  _model.lastNameTextController?.text = _model.user!.lastName;
                });
              } else {
                if (_model.user?.fullName != null &&
                    _model.user?.fullName != '') {
                  safeSetState(() {
                    _model.lastNameTextController?.text = functions
                        .getLastNameFromFullName(_model.user?.fullName);
                  });
                }
              }
            }),
            Future(() async {
              safeSetState(() {
                _model.emailTextController?.text = _model.user!.email;
              });
            }),
            Future(() async {
              safeSetState(() {
                _model.phoneTextController?.text = _model.user!.phone;
              });
            }),
            Future(() async {
              _model.birthDate = _model.user?.dateOfBirth;
            }),
            Future(() async {
              safeSetState(() {
                _model.addressTextController?.text = _model.user!.address;
              });
            }),
            Future(() async {
              safeSetState(() {
                _model.cityTextController?.text = _model.user!.city;
              });
            }),
            Future(() async {
              safeSetState(() {
                _model.postalCodeTextController?.text = _model.user!.postalCode;
              });
            }),
            Future(() async {
              safeSetState(() {
                _model.stateTextController?.text = _model.user!.state;
              });
            }),
          ]);
        }),
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  FFLocalizations.of(context).getText(
                                    'av0ohflf' /* Inserisci i tuoi dati per cont... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                ...
                                Align(
                                  alignment: AlignmentDirectional(0.0, 0.0),
                                  child: wrapWithModel(
                                    model: _model.imageProfileModel,
                                    updateCallback: () => safeSetState(() {}),
                                    child: ImageProfileWidget(
                                      imagepathnew: _model.user?.profilePicture,
                                    ),
                                  ),
                                ),
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      FlutterFlowDropDown<UserGender>(
                                        controller:
                                          ...
                                          children: [
                                            ...
                                            FlutterFlowDropDown<String>(
                                              ...
                                              options: List<String>.from(_model
                                                  ...
                                                  .map((e) => e.code)
                                                  .toList()),
                                              optionLabels: _model.country!
                                                  .map((e) => e.name)
                                                  .toList(),
                                              onChanged: (val) => safeSetState(
                                                  () => _model
                                                      .countryCodeValue = val),
                                              height: 48.0,
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          '8r7q2uum' /* Questa è la lingua in cui visu... */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                ...
                                onPressed: () async {
                                  ...
                                  if (_model.birthDate == null) {
                                    ...
                                    _model.apiResultUpdateUserProfile =
                                      ...
                                      dateOfBirth: _model.birthDate?.toString(),
                                      address:
                                      ...
                                      gender: _model.genderValue?.name,
                                    );

                                    _shouldSetState = true;
                                    if ((_model.apiResultUpdateUserProfile
                                            ?.succeeded ??
                                        true)) {
                                      unawaited(
                                        () async {
                                      ...
                                      _model.apiResulty9i = await SupabaseGroup
                                          .syncimagefromjectcventerpriseCall
                                          .call(
                                        fileJson: functions.castFileToJSON(
                                            _model.imageProfileModel
                                                .imageProfile!),
                                        userId: FFAppState().loggedUserId,
                                      );

                                      _shouldSetState = true;
                                      if (_model.user?.type ==
                                          UserType.certifier) {
                                        if ((_model.user?.kycCompleted ==
                                                null) ||
                                            (_model.user?.kycPassed == null) ||
                                            (_model.user?.kycPassed == false)) {
                                      ...
                                      } else if (_model.user?.type ==
                                          UserType.legal_entity) {
                                        if (Navigator.of(context).canPop()) {
                                          context.pop();
                                        }
                                        context.pushNamed(
                                          LegalEntityInformationWidget
                                              .routeName,
                                          queryParameters: {
                                      ...
                                      unawaited(
                                        () async {
                                          await action_blocks.snackbar(
                                            ...
                                            message:
                                                'Errore durante l\'aggiornamento dati',
                                          );
                                        }(),
                                      );
                                      unawaited(
