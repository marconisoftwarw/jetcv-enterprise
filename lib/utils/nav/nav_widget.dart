            ...
            if (!_model.isLoading)
              Column(
                ...
                children: [
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                ...
                                context
                                    .pushNamed(UserInformationWidget.routeName);
                              },
                              child: Row(
                                mainAxisSize: MainAxisSize.max,
                                children: [
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        ...
                        context.pushNamed(UserInformationWidget.routeName);
                      },
                      child: Container(
                        width: double.infinity,
                        height: 50.0,
                  ...
                  if (_model.user?.type == UserType.legal_entity)
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(16.0, 0.0, 16.0, 12.0),
                      child: InkWell(
                        ...
                        onTap: () async {
                          ...
                          context.pushNamed(
                              LegalEntityInformationWidget.routeName);
                        },
                        child: Container(
                          width: double.infinity,
                          height: 50.0,
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          ...
                          context.pushNamed(MyWalletsWidget.routeName);
                        },
                        child: Container(
                          width: double.infinity,
                          height: 50.0,
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                      ...
                                      await showDialog<bool>(
                                            ...
                                            builder: (alertDialogContext) {
                                              return AlertDialog(
                                                ...
                                                content: Text(
                                                    'Sei sicuro di voler eliminare definitivamente il tuo account? L\'azione non è reversibile.'),
                                                actions: [
                                                  TextButton(
                                                    onPressed: () =>
                                                        Navigator.pop(
                                  ...
                                  if (confirmDialogResponse) {
                                    _model.apiResultDeleteUserAndAssociatedData =
                                        await SupabaseGroup
                                    ...
                                    if ((_model.apiResultDeleteUserAndAssociatedData
                                                ?.succeeded ??
                                            true) &&
                                        SupabaseGroup
                                            .deleteUserAndAssociatedDataCall
                                      ...
                                      unawaited(
                                        () async {
                                          await action_blocks.snackbar(
                                            ...
                                            message:
                                                'Errore durante la cancellazione account utente',
                                          );
                                        }(),
                                      );
                                      unawaited(
                                        () async {
                                          await action_blocks.apiFailure(
                                            context,
                                            tag:
                                                'apiResultDeleteUserAndAssociatedData',
                                            jsonBody: (_model
                                                    .apiResultDeleteUserAndAssociatedData
                                                    ?.jsonBody ??
                                                ''),
