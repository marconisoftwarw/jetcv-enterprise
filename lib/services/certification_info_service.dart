...
class CertificationInfoService {
  ...
  static Future<Map<String, dynamic>?> getCertificationInfo(String certificationId) async {
    try {
      ...
      print('🔍 CertificationInfoService: Response status: ${response.statusCode}');
      ...
      if (response.statusCode == 200) {
        ...
        if (data['ok'] == true) {
          ...
          print('❌ CertificationInfoService: API returned error: ${data['error']}');
          return null;
        }
      } else {
        print('❌ CertificationInfoService: HTTP error ${response.statusCode}: ${response.body}');
        return null;
      }
    } catch (e) {
  ...
  static Future<Map<String, Map<String, dynamic>>> getMultipleCertificationsInfo(List<String> certificationIds) async {
  ...
  static Future<bool> testConnection() async {
    try {
      ...
      print('🧪 CertificationInfoService: Connection test status: ${response.statusCode}');
