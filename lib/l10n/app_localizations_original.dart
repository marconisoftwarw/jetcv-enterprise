...
class AppLocalizations {
  ...
  static const _localizedValues = {
    ...
    'en': {
      ...
      'please_enter_email': 'Please enter your email address first',
      'reset_password': 'Reset Password',
      'reset_password_form_description':
          'Enter your current password and new password to reset access',
      ...
      'password_reset_success_message':
          'Your password has been reset successfully. You can now login with the new password.',
      'password_reset_error': 'Password Reset Error',
      'password_reset_error_message':
          'An error occurred while resetting the password. Please verify that the current password is correct and try again.',
      ...
      'media_photos_videos': 'Media (Photos and Videos)',
      'add_photos_videos': 'Add photos and videos',
      'add': 'Add',
      'continue': 'Continue',
      'add_users': 'Add Users',
      'enter_participants': 'Enter certification participants',
      'enter_user_otp': 'Enter user OTP code',
      'enter_otp_code': 'Enter OTP code...',
      'scan_qr_code': 'Scan QR Code',
      'scan_qr_from_app': 'Scan QR code from user app',
      'scan': 'Scan',
      'added_users': 'Added Users',
      'remove_all': 'Remove All',
      'user_results': 'User Results',
      'enter_results_for_each': 'Enter results for each user',
      'fill_fields_for_participants':
          'Fill fields for each certification participant',
      'result': 'Result',
      'passed': 'Passed',
      'score': 'Score',
      'evaluation': 'Evaluation',
      'media_photos_videos_short': 'Media (Photos and Videos)',
      ...
      'once_sent_warning':
          'Once sent, the certification will be sent to recipient users and will no longer be editable. Once users accept the certification, it will be notarized on the blockchain. This action cannot be undone.',
      'confirm_verification':
      ...
      'certification_sent_success':
          'Certification "Platform Management in-place Course" has been sent successfully.',
      'recipients_notification':
          'Recipients will receive a notification and can view the certification in their profiles.',
      'completed': 'Completed',
      'certified': 'Certified',
      'no_drafts_available': 'No drafts available',
      'drafts_will_appear_here':
          'Your drafts and in-progress certifications will appear here',
      'logout': 'Logout',
    ...
    'de': {
      ...
      'please_enter_email': 'Bitte geben Sie zuerst Ihre E-Mail-Adresse ein',
      'reset_password': 'Passwort zurücksetzen',
      'reset_password_form_description':
          'Geben Sie Ihr aktuelles Passwort und neues Passwort ein, um den Zugang zurückzusetzen',
      'current_password': 'Aktuelles Passwort',
      'enter_current_password': 'Aktuelles Passwort eingeben',
      'new_password': 'Neues Passwort',
      'enter_new_password': 'Neues Passwort eingeben',
      'confirm_new_password': 'Neues Passwort bestätigen',
      'confirm_new_password_hint': 'Neues Passwort bestätigen',
      'current_password_required': 'Aktuelles Passwort erforderlich',
      'new_password_required': 'Neues Passwort erforderlich',
      'confirm_password_required': 'Passwort-Bestätigung erforderlich',
      'passwords_do_not_match': 'Passwörter stimmen nicht überein',
      'resetting_password': 'Passwort wird zurückgesetzt...',
      'password_reset_success': 'Passwort zurückgesetzt',
      'password_reset_success_message':
          'Ihr Passwort wurde erfolgreich zurückgesetzt. Sie können sich jetzt mit dem neuen Passwort anmelden.',
      'password_reset_error': 'Passwort-Reset-Fehler',
      'password_reset_error_message':
          'Beim Zurücksetzen des Passworts ist ein Fehler aufgetreten. Bitte überprüfen Sie, ob das aktuelle Passwort korrekt ist, und versuchen Sie es erneut.',
      ...
      'testimonial_text':
          'Ausgezeichnete Plattform für die Unternehmenszertifizierung. Einfach zu verwenden und sehr zuverlässig.',
      ...
      'certification_title': 'Zertifizierungstitel',
      'certification_code': 'Code',
      'certification_detail': 'Detail',
      ...
      'media_photos_videos': 'Medien (Fotos und Videos)',
      'add_photos_videos': 'Fotos und Videos hinzufügen',
      'add': 'Hinzufügen',
      'continue': 'Weiter',
      'add_users': 'Benutzer hinzufügen',
      'enter_participants': 'Zertifizierungsteilnehmer eingeben',
      'enter_user_otp': 'Benutzer-OTP-Code eingeben',
      'enter_otp_code': 'OTP-Code eingeben...',
      'scan_qr_code': 'QR-Code scannen',
      'scan_qr_from_app': 'QR-Code aus der Benutzer-App scannen',
      'scan': 'Scannen',
      'added_users': 'Hinzugefügte Benutzer',
      'remove_all': 'Alle entfernen',
      'user_results': 'Benutzerergebnisse',
      'enter_results_for_each': 'Ergebnisse für jeden Benutzer eingeben',
      'fill_fields_for_participants':
          'Felder für jeden Zertifizierungsteilnehmer ausfüllen',
      'result': 'Ergebnis',
      'passed': 'Bestanden',
      'score': 'Punktzahl',
      'evaluation': 'Bewertung',
      'media_photos_videos_short': 'Medien (Fotos und Videos)',
      'certification_review': 'Zertifizierungsüberprüfung',
      'check_details_before_sending':
          'Alle Details vor dem Senden der Zertifizierung überprüfen',
      'review_and_send': 'Überprüfen und Senden',
      'general_info_lower': 'Allgemeine Informationen',
      'real_time_media': 'Echtzeit-Medien',
      'no_general_media': 'Keine allgemeinen Medien angehängt',
      'users_count': 'Benutzer',
      'certifier_media': 'Zertifizierer-Medien',
      'confirm_send': 'Senden bestätigen',
      'once_sent_warning':
          'Nach dem Senden wird die Zertifizierung an die Empfängerbenutzer gesendet und ist nicht mehr bearbeitbar. Sobald Benutzer die Zertifizierung akzeptieren, wird sie in der Blockchain notariell beglaubigt. Diese Aktion kann nicht rückgängig gemacht werden.',
      'confirm_verification':
          'Ich bestätige, dass ich alle Details überprüft habe und mit dem Senden der Zertifizierung fortfahren möchte',
      ...
      'certification_sent_success':
          'Zertifizierung "Plattform-Management vor Ort Kurs" wurde erfolgreich gesendet.',
      'recipients_notification':
          'Empfänger erhalten eine Benachrichtigung und können die Zertifizierung in ihren Profilen anzeigen.',
      'completed': 'Abgeschlossen',
      'certified': 'Zertifiziert',
      'no_drafts_available': 'Keine Entwürfe verfügbar',
      'drafts_will_appear_here':
          'Ihre Entwürfe und laufenden Zertifizierungen werden hier angezeigt',
      'logout': 'Abmelden',
    ...
    'fr': {
      ...
      'please_enter_email': 'Veuillez d\'abord saisir votre adresse e-mail',
      'reset_password': 'Réinitialiser le mot de passe',
      'reset_password_form_description':
          'Saisissez votre mot de passe actuel et nouveau mot de passe pour réinitialiser l\'accès',
      ...
      'confirm_new_password_hint': 'Confirmer le nouveau mot de passe',
      ...
      'password_reset_success_message':
          'Votre mot de passe a été réinitialisé avec succès. Vous pouvez maintenant vous connecter avec le nouveau mot de passe.',
      'password_reset_error': 'Erreur de réinitialisation du mot de passe',
      'password_reset_error_message':
          'Une erreur s\'est produite lors de la réinitialisation du mot de passe. Veuillez vérifier que le mot de passe actuel est correct et réessayer.',
      ...
      'certifications_issued': 'Certifications délivrées',
      ...
      'testimonial_text':
          'Excellente plateforme pour la gestion des certifications d\'entreprise. Facile à utiliser et très fiable.',
      ...
      'certification_title': 'Titre de certification',
      'certification_code': 'Code',
      'certification_detail': 'Détail',
      'certification_media': 'Médias',
      'certification_location': 'Lieu',
      ...
      'other': 'Autre',
      'description': 'Description',
      'media_photos_videos': 'Médias (Photos et Vidéos)',
      'add_photos_videos': 'Ajouter des photos et vidéos',
      'add': 'Ajouter',
      'continue': 'Continuer',
      'add_users': 'Ajouter des utilisateurs',
      'enter_participants': 'Saisir les participants à la certification',
      'enter_user_otp': 'Saisir le code OTP utilisateur',
      'enter_otp_code': 'Saisir le code OTP...',
      'scan_qr_code': 'Scanner le code QR',
      'scan_qr_from_app': 'Scanner le code QR depuis l\'app utilisateur',
      'scan': 'Scanner',
      'added_users': 'Utilisateurs ajoutés',
      'remove_all': 'Tout supprimer',
      'user_results': 'Résultats utilisateurs',
      'enter_results_for_each': 'Saisir les résultats pour chaque utilisateur',
      'fill_fields_for_participants':
          'Remplir les champs pour chaque participant à la certification',
      'result': 'Résultat',
      'passed': 'Réussi',
      'score': 'Score',
      'evaluation': 'Évaluation',
      'media_photos_videos_short': 'Médias (Photos et Vidéos)',
      'certification_review': 'Révision de certification',
      'check_details_before_sending':
          'Vérifier tous les détails avant d\'envoyer la certification',
      'review_and_send': 'Réviser et Envoyer',
      'general_info_lower': 'Informations générales',
      'real_time_media': 'Médias en temps réel',
      'no_general_media': 'Aucun média général joint',
      'users_count': 'Utilisateurs',
      'certifier_media': 'Médias du certificateur',
      'confirm_send': 'Confirmer l\'envoi',
      'once_sent_warning':
          'Une fois envoyée, la certification sera envoyée aux utilisateurs destinataires et ne sera plus modifiable. Une fois que les utilisateurs accepteront la certification, elle sera notarisée sur la blockchain. Cette action ne peut pas être annulée.',
      'confirm_verification':
          'Je confirme avoir vérifié tous les détails et vouloir procéder à l\'envoi de la certification',
      'send_certification': 'Envoyer la certification',
      'continue_to_review': 'Continuer vers la révision',
      'certification_sent': 'Certification envoyée !',
      'certification_sent_success':
          'La certification "Cours de gestion de plateforme sur site" a été envoyée avec succès.',
      'recipients_notification':
          'Les destinataires recevront une notification et pourront voir la certification dans leurs profils.',
      'completed': 'Terminé',
      'certified': 'Certifié',
      'no_drafts_available': 'Aucun brouillon disponible',
      'drafts_will_appear_here':
          'Vos brouillons et certifications en cours apparaîtront ici',
      'logout': 'Déconnexion',
